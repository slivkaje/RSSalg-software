/** 	
 * Name: ClassifiedInstance.java
 * 
 * Purpose: Object that represents an instance classified by a single classifier or by ensamble of classifiers (id, classifier confidence for each label and actual label).
 * 
