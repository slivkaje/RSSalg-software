/** 	
 * Name: Confidences.java
 * 
 * Purpose: For each classifier from one ensemble and each possible class: confidence of the classifier that the instance belongs to the class.
 * 
