/** 	
 * Name: CoTraining.java
 * 
 * Purpose: Class implementing the co-training algorithm as proposed in A. Blum, T. Mitchell, "Combining labeled and unlabeled data with co-training", COLT: Proceedings of the Workshop on Computational Learning Theory, Morgan Kaufmann, 1998, p. 92-100.
 * 
